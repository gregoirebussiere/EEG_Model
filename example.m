...
trialcsvloc = sprintf('%s/trialdata-new.csv',datafolder);
trialcsvNANloc = sprintf('%s/trialdataNAN-new.csv',datafolder);
...
sescondcsvloc = sprintf('%s/sesconddata-new.csv',datafolder);
sescondcsvNANloc = sprintf('%s/sesconddataNAN-new.csv',datafolder);
...
%Calculate and remove RT        %% This is important to do!
